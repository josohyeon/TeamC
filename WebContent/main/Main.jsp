		...
		<ul>
			...
			<li>
				<div class="item">
						...
						{
						%>
					<img src="../images/cal.png" width="130px" onclick="javascript:alert('로그인이 필요합니다.')" style="padding-top: 15px">
					<p>금연계산기</p>
						<%
						}else
						{
						%>
					<a href="../mypage/Mypage.jsp"><img src="../images/cal.png" width="130px" style="padding-top: 15px"></a>
					<p>금연계산기</p>
						<%				
						}
						%>					
